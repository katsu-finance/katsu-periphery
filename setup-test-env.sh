...
if [ ! "$COVERAGE" = true ]; then
    ...
    # compile @hedy_chu/core-v3 contracts
    npm run compile
else
...
# required by @hedy_chu/deploy-v3 hardhat plugin due hardhat package.json resolution
...
cp -r 'node_modules/@hedy_chu/deploy-v3/artifacts/@aave/safety-module/contracts/stake' temp-artifacts/deploy
cp -r 'node_modules/@hedy_chu/deploy-v3/artifacts/@aave/safety-module/contracts/proposals' temp-artifacts/deploy/stake
